...
<!-- Template Stylesheet -->
<link href="{{asset('home/css/style5.css')}}" rel="stylesheet">
...
<!-- ????????????? -->
   ...
   <link rel="stylesheet" href="{{asset('home/css/css2.css')}}">
                              ...
                              <div class="row g-3">
                                    ...
                                    <!-- <div class="col-md-6">
                                        ...
                                        <div class="form-floating">
                                            <select class="form-select" id="select1">
                                              <option value="1"> bassma</option>
                                              <option value="2"> movenbic</option>
                                              <option value="3">cataract</option>
                                              <option value="3">kendaka</option>
                                              <option value="3">katadol</option>
                                              <option value="3">nobe bin</option>
                                              <option value="3">tolib</option>
                                              <option value="3">city max</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating date" id="date3" data-target-input="nearest">
                                            <input type="date" class="form-control datetimepicker-input" id="checkin" name="check_in" placeholder="Check In" data-target="#date3" data-toggle="datetimepicker" />
                                            <label for="checkin">Check In</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating date" id="date4" data-target-input="nearest">
                                            <input type="date" class="form-control datetimepicker-input" id="checkout" name="check_out" placeholder="Check Out" data-target="#date4" data-toggle="datetimepicker" />
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-floating">
                                            <input type="number" class="form-select" id="select3" placeholder="number" name="select_room">
                                   ...
                                   <!-- //// -->
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit"> <a href="#" target="_blank">Book Now</a> </button>
                                    </div>
                                </div>
                            </form>
                        </div>
