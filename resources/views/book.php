...
<!-- header section ends -->
 ...
 <div class="container-fluid p-0 mb-5">
        ...
        <!-- Booking Start -->
        <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="1.1s">
            <div class="container">
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        ...
                        <div class="col-md-2">
                            <button  class="btn btn-primary w-100"> <a href="hotel.php" target="_blank">Submit </a> </button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="aswan.php" target="_blank">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- booking section starts  -->
 ...
 <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/15616124.jpg?k=ed04302e1491aee376a87167c6b27eaa2c9e97922f34fe53a4c9672a8ab0d987&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$90.00</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>Tempor erat elitr rebum at clita. Diam dolor</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/326740575.jpg?k=8a33ae70e7aae3b07ed3e86ae565f6d908f7d8c54cc93b2eb900abc948e45957&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/237644998.jpg?k=0525c42f21060b5b4d9b046e90816b4e56cbd34f76985413b9a3504da0736b8d&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$ 50.00 </small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/297461757.jpg?k=30ee0197a1f8e7b14d948e2dfaebff768c0c9d5e269c9dc2dd2fda90cd018d4d&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$50.00 </small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/331302408.jpg?k=8e4e53ce2125875e44c48dc9361cfd425e2d972fd4ceddd844b93745a693a52e&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$50.00</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/288782500.jpg?k=1ac589eee7a3d83ef2e8abe567e483f58bd28aa265073f19410ddebfd7bfffd2&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$50.00</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/269281491.jpg?k=3cd59613c4674678a24605ceb6fce32af280bb732a11af1ef05fe99ca8f70262&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$50.00</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/273965927.jpg?k=b85de18353eeb479b554ee84faea768fea2888e2e3d4c1b765654761eb3d710a&o=&hp=1" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>$50.00</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i></small>
                        ...
                        <div class="text-center p-4">
                            <h3 class="mb-0">Basma Hotel Aswan</h3>
                            <div class="mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
    ...
    <!-- Package End -->
    <!-- FACILITES -->
<h2 class="mt-5 pt-4 mb-5 text-center fw-bold h-font" >OUR FACILITES</h2>
<div class="container">
