...
<div class="heading" style="background:url(images/mur.png) no-repeat">
    <h1>
        Nubian Museum
    </h1>
</div>
...
<section class="about">
    ...
    <div class="image">
        <img src="images/nb2.png" alt="">
    </div>

    <div class="content">
        <h3>About the Sight</h3>
        <p>Aswan, south of Egypt, is the home of a wonderful culture called Nubia. Nubians people have their own traditions, language and life style. Their culture was a result of ancient Egyptian and African culture engagement, when the South Africans migrated up to Egypt and settled there in the time of pharaohs.
            They still practice some of their own traditions which are deeply related to ancient Egyptians until our day. We have discussed their life style in details in the Nubian villages article, but in this one we'll the treasures of Nubia displayed in Nubian museum Aswan.</p>
        ...
        <div class="icons-container">
            <div class="icons">
                ...
                <span>The Tour Duration is:<strong> 2-3 </strong>Hours </span>
            </div>
            <div class="icons">
                <i class="fas fa-hand-holding-usd"></i>
                <span>Tour Cost:<br><strong>200LE</strong></span>
            </div>
            <div class="icons">
                <i class="fas fa-headset"></i>
                <span>Best<strong> TourGuide</strong> Service</span>
            </div>
        </div>

        <!-- <br><br><a href="tourbook" class="btn">book now</a> -->
    </div>
