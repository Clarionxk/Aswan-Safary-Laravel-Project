...
<head>
    ...
    <title>The Unfinished Obelisk</title>
...
<div class="heading" style="background:url(images/ob.png) no-repeat">
    <h1>
...
<section class="about">
    ...
    <div class="image">
        <img src="images/ob2.png" alt="">
    </div>

    <div class="content">
        <h3>About the Sight</h3>
        <p> Abandoned thousands of years ago in the quarries of Aswan, the Unfinished Obelisk is a granite would-be monument that was never finished. It is one of the most important archaeological finds in Egypt for the insight it has provided into ancient stonemasonry methods.
            As its name suggests, the Obelisk - which would have been the heaviest single stone monument the Egyptians ever created - was never finished. Three sides of the enormous shaft were completed when the masons discovered a crack in the granite and abandoned it, still half attached to the bedrock it was being carved from.</p>
